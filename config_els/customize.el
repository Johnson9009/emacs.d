...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(tabbar-default ((t (:inherit variable-pitch :background "gray30" :foreground "brightwhite" :height 0.8))))
 '(tabbar-modified ((t (:inherit tabbar-default :foreground "brightred" :box (:line-width 1 :color "white" :style released-button)))))
 '(tabbar-selected ((t (:inherit tabbar-default :foreground "#62e300"))))
 '(tabbar-selected-modified ((t (:inherit tabbar-default :foreground "yellow" :box (:line-width 1 :color "white" :style released-button)))))
 '(tabbar-separator ((t (:inherit tabbar-default :foreground "brightblue"))))
 '(whitespace-newline ((t (:foreground "#212121"))))
 '(whitespace-space ((t (:foreground "#212121" :slant italic)))))
